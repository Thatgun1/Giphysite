$(document).ready(function () {
	var movies = ["Die Hard", "Inglorious Basterds", "Anchorman", "Inception", "Guardians of the Galaxy", "Donnie Darko"];

	// Add buttons for original movies array
	function renderButtons() {
		$("#movie-buttons").empty();
		for (i = 0; i < movies.length; i++) {
			$("#movie-buttons").append("<button class='btn btn-warning' data-movie='" + movies[i] + "'>" + movies[i] + "</button>");
		}
	}
	...
	$("button").on("click", function () {
		...
		var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
			movie + "&api_key=JXmbI3d3OS112YXoNWEkOIWtc0bSOkDC"
